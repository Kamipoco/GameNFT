...
contract VestingWallet is Context {
    ...
    constructor(
        ...
        require(beneficiaryAddress != address(0), "VW: beneficiary is zero address");
    ...
    function _setToken(address token) internal {
        require(token != address(0),"VW: Token is zero");
        erc20Token = token;
    }
    ...
    function release() public virtual {
        uint256 releasable = vestedAmount(erc20Token, uint64(block.timestamp)) - released();
        _erc20Released += releasable;
        emit ERC20Released(erc20Token, releasable);
        SafeERC20.safeTransfer(IERC20(erc20Token), beneficiary(), releasable);
    }
